# The AppBrahma Unimobile Ionic Starter Application

The universal ionic mobile app for appbrahma back-end

The Appbrahma unimobile starter is designed to be used with a Appbrahma backend [Unimobile for APpBrahma](https://www.brillium.tech/appbrahma/unimobile/ionic).

This project provides a base template of functionality for an Ionic app. The Ionic for Appbrahma module provides OAuth authentication to connect to AppBrahma or any other REST back-end
